...
<body>
    <div class="container">
        ...
        <div class="sub-div">
            ...
            <div class="right-div">
                <div  class="login-div">
                    <p class="para">Login as farmer,</p>
                    ...
                    <div class="form">
                        <form method="POST" action="farmerlog.php" onsubmit="return validation()">
                            <div class="user1">
                                <span class="material-icons-outlined">
                                    person_outline
                                    </span>
                                <input type="text" placeholder="Username" id="text" name="tableuser" >
                            ...
                            <div class="lock">
                                ...
                                <span class="material-icons-outlined" id="visibility-on" onclick="visibility_on()">
                                   visibility
                                      </span>
                                <span class="material-icons-outlined" id="visibility-off" onclick="visibility_off()">
                                        visibility_off
                                 </span>
                            </div>
                            ...
                            <div class="button">
                                ...
                                <a href="../farmsignup/farsignup.php?user=new">Don't have an account?<b>Register here</b></a>
                            </div>
                        </form>
